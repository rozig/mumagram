...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/mumagram/images/apple-touch-icon.png">
	<link rel="icon" type="image/png" sizes="32x32" href="/mumagram/images/favicon-32x32.png">
	<link rel="icon" type="image/png" sizes="16x16" href="/mumagram/images/favicon-16x16.png">
	<link rel="mask-icon" href="/mumagram/images/safari-pinned-tab.svg" color="#5bbad5">
