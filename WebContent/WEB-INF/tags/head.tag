...
<meta charset="utf-8">
<link rel="apple-touch-icon" sizes="180x180" href="${baseUrl}/assets/images/apple-touch-icon.png">
...
<link rel="mask-icon" href="${baseUrl}/assets/images/safari-pinned-tab.svg" color="#5bbad5">
